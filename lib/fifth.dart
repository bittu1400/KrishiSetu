...
//   const CropDashboard({
//     Key? key,
//     this.userData, // Make it optional for backward compatibility
//   }) : super(key: key);
...
//   void initState() {
//     super.initState();
//     // Use userData from registration or default values
//     String name = widget.userData?['name'] ?? 'Krishna';
//     String cityName = widget.userData?['city'] ?? 'Kathmandu';
...
//     fetchDashboardData(name, cityName);
//   }

//   Future<void> fetchDashboardData(String name, String cityName) async {
//     try {
//       // Replace with your actual backend URL
//       final response = await http.post(
//         Uri.parse('http://127.0.0.1:8000/dashboard'),
//         headers: {'Content-Type': 'application/json'},
//         body: jsonEncode({'name': name, 'city': cityName}),
//       );
...
import 'chat.dart';
import 'tools.dart';
import 'detector.dart'; // Import the new detector page
import 'experts.dart';
import 'profile.dart';
      ...
      child: Row(children: [
        Expanded(
          child: GestureDetector(
            onTap: () => Navigator.push(
              context,
              MaterialPageRoute(builder: (_) => const CropDiagnosisCamera()),
            ),
            child: _buildActionCard(
              Icons.camera_alt,
              'Crop Diagnosis',
